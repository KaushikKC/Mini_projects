...
let listofmovies =`Here is your list of details of meta in a nice simple list`;
let MongoURI = 'http://localhost:8081/mongodb/meta'
...
const MetaDetails = () => {
    ...
    function MetaItem(props) {
        ...
        const metathing = (
            <div>
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col">
                            ...
                            <img className="fimg rounded" style={{width:'40%'}} src={props.detail.Founder.url} alt="" />
                        ...
                        <div class="col">
                            ...
                            <h3 className="fw-bold fs-2">COO</h3>
                            ...
                            <h5>Year she become COO : {props.detail.Ceo.yearf}</h5>
                ...
                <h4>Year she become COO : {props.detail.Ceo.yearf}</h4>
                <hr /> */}
            </div>
        );
        return metathing;
    ...
    (
        ...
        <MetaItem key={singlecompanyitem._id} detail={singlecompanyitem} />
                 )}
